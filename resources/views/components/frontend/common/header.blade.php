                    ...
                    <div class=" max-w-[719px] flex-1 relative z-[999999]">
                        <div class="flex w-full overflow-hidden rounded-sm ">
                            <div class="flex-1">
                                ...
                                <input type="type" id="searchKeyword" onkeyup="searchProduct(this.value)" class="block w-full py-3 px-10 text-sm text-gray-900 border border-gray-300 rounded-lg outline-none" placeholder="Search your product..." />
                            </div>
