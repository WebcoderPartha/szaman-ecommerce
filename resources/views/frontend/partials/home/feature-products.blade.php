        ...
        <div class="relative">
            <div class="swiper featureProductSlider">
                ...
                @foreach($feature_products as $feature_product)
                    <!-- Single Product -->
                        <div class="swiper-slide">
                            <div class="product-card group flex flex-col text-center border border-[#efefef] rounded-lg ">
                                <a href="{{ route('frontend.product.details', $feature_product->slug) }}" class="product-img rounded-tl-lg rounded-tr-lg overflow-hidden relative">
                                    <img class=" group-hover:scale-125 duration-500 border-b border-theme" height="200" src="{{ asset('/storage/product/'.$feature_product->feature_image) }}" alt="{{ $feature_product->feature_image }}">
                        ...
                        <span class=" text-white text-xs">
                            <span class="font-bold">Flat {{$feature_product->discount}}% Off</span>
                                ...
                                <div class="product-price-info flex flex-col gap-2 py-4 items-center min-h-[180px]">
                                    <a class="min-h-[60px]" href="{{ route('frontend.product.details', $feature_product->slug) }}"><h2 class="text-[16px] group-hover:text-theme font-semibold duration-500 px-2">{{ Str::limit($feature_product->title, 60) }}</h2></a>
...
{{--                                    </div>--}}
                ...
                <span class="feature-swiper-button-next absolute top-[40%] -left-0 z-[9999]"><i class="border border-theme rounded-full px-2 bg-theme pt-[2px] pb-[2px] fa-solid fa-arrow-left text-2xl text-white"></i></span>
                <span class="feature-swiper-button-prev absolute top-[40%] -right-0 z-[9999]"><i class="border border-theme hover:bg-theme hover:text-white rounded-full px-2 pt-[2px] pb-[2px] fa-solid fa-arrow-right text-2xl bg-theme text-white"></i></span>
            </div>
        </div>
