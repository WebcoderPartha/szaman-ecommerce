...
<div class="hot-products flex flex-col gap-3 my-4">
    <div class="flex flex-row justify-center items-center border-b border-b-[#ced4da] py-4">
        <div class="">
            <h2 class="text-base md:text-2xl text-center font-semibold bg-theme text-white py-1 px-16">HOT DEAL</h2>
        </div>
    ...
    <div class="relative">
        <div class="swiper hotDealSlider">
                                    ...
                                    @if($hot_deal->discount !== null)
                                        <div class="flex flex-row gap-2 items-center justify-center">
                                            <div class="flex flex-row justify-center items-center gap-x-0.5 text-[12px] font-bold line-through">
                                                <span> TK</span><span>{{$hot_deal->unit_price}}</span>
                                            </div>

                                            <div class="text-[13px] text-theme font-bold flex items-center">
                                                <span> TK </span><span>&nbsp;{{$hot_deal->discount_price}}</span>
                                            </div>
                                        </div>
                                    @else
            ...
            <span class="hotdeal-swiper-button-next absolute top-[40%] -left-0 z-[9999]"><i class="border border-theme rounded-full px-2 bg-theme pt-[2px] pb-[2px] fa-solid fa-arrow-left text-2xl text-white"></i></span>
            <span class="hotdeal-swiper-button-prev absolute top-[40%] -right-0 z-[9999]"><i class="border border-theme hover:bg-theme hover:text-white rounded-full px-2 pt-[2px] pb-[2px] fa-solid fa-arrow-right text-2xl bg-theme text-white"></i></span>
        </div>
    </div>
