...
<div class="best-selling-products flex flex-col gap-3 my-4">
    <div class="flex flex-row justify-center items-center border-b border-b-[#ced4da] py-4">
        <div class="">
            <h2 class="text-base md:text-2xl text-center font-semibold bg-theme text-white py-1 px-16">BEST SELLING</h2>
        </div>
                                    ...
                                    @if($best_sell->discount !== null)
                                        <div class="flex flex-row gap-2 items-center justify-center">
                                            <div class="flex flex-row justify-center items-center gap-x-0.5 text-[12px] font-bold line-through">
                                                <span> TK</span><span>{{$best_sell->unit_price}}</span>
                                            </div>

                                            <div class="text-[13px] text-theme font-bold flex items-center">
                                                <span> TK </span><span>&nbsp;{{$best_sell->discount_price}}</span>
                                            </div>
                                        </div>
                                    @else
